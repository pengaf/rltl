...
template<typename Element_t_, size_t t_size_0_, size_t... t_sizes>
class Array;
...
public:
	...
	static const size_t t_size_0 = t_size_0_;
	static const size_t t_dim = 1;
	static const size_t t_size = t_size_0;
	static const size_t t_sub_size = t_size_0;
	static std::array<size_t, t_dim> shape()
	{
		std::array<size_t, t_dim> shp;
		shp[0] = ArrayLike::t_size_0;
		return shp;
	}

	template<size_t n>
	static void fill_shape_(std::array<size_t, n>& shape, size_t offset)
	{
...
template<typename Element_t_, size_t t_size_0_, size_t t_size_1_, size_t... t_sizes>
class ArrayLike<Element_t_, t_size_0_, t_size_1_, t_sizes...>
{
public:
	typedef Element_t_ Element_t;
	static const size_t t_size_0 = t_size_0_;
	static const size_t t_size_1 = t_size_1_;
...
template<typename Element_t_, size_t t_size_0_, size_t... t_sizes>
class ArrayConstView : public ArrayLike<Element_t_, t_size_0_, t_sizes...>
{
public:
	typedef Element_t_ Element_t;
	static const size_t t_size_0 = t_size_0_;
...
template<typename Element_t_, size_t t_size_0_, size_t t_size_1_, size_t... t_sizes>
class ArrayConstView<Element_t_, t_size_0_, t_size_1_, t_sizes...> : public ArrayLike<Element_t_, t_size_0_, t_size_1_, t_sizes...>
{
public:
	typedef Element_t_ Element_t;
	static const size_t t_size_0 = t_size_0_;
	static const size_t t_size_1 = t_size_1_;
	static const size_t t_sub_size = ArrayConstView<Element_t, t_size_1, t_sizes...>::t_size;
	static const size_t t_sub_dims = ArrayConstView<Element_t, t_size_1, t_sizes...>::t_dim;
	static const size_t t_dim = 1 + t_sub_dims;
	static const size_t t_size = t_size_0 * t_sub_size;
public:
	ArrayConstView(const Element_t* elements) :
...
template<typename Element_t_, size_t t_size_0_, size_t... t_sizes>
class ArrayView : public ArrayLike<Element_t_, t_size_0_, t_sizes...>
{
public:
	typedef Element_t_ Element_t;
	static const size_t t_size_0 = t_size_0_;
...
template<typename Element_t_, size_t t_size_0_, size_t t_size_1_, size_t... t_sizes>
class ArrayView<Element_t_, t_size_0_, t_size_1_, t_sizes...> : public ArrayLike<Element_t_, t_size_0_, t_size_1_, t_sizes...>
{
public:
	typedef Element_t_ Element_t;
	static const size_t t_size_0 = t_size_0_;
	static const size_t t_size_1 = t_size_1_;
	static const size_t t_sub_size = ArrayView<Element_t, t_size_1, t_sizes...>::t_size;
	static const size_t t_sub_dims = ArrayView<Element_t, t_size_1, t_sizes...>::t_dim;
	static const size_t t_dim = 1 + t_sub_dims;
	static const size_t t_size = t_size_0 * t_sub_size;
public:
	ArrayView(Element_t* elements) :
...
template<typename Element_t_, size_t t_size_0_, size_t t_size_1_, size_t... t_sizes>
class Array<Element_t_, t_size_0_, t_size_1_, t_sizes...>
{
public:
	typedef Element_t_ Element_t;
	static const size_t t_size_0 = t_size_0_;
...
template<typename Element_t_, size_t t_size_0_, size_t... t_sizes>
struct Array_ElementType<Array<Element_t_, t_size_0_, t_sizes...>>
{
	typedef Element_t_ Element_t;
};
...
struct Array_Shape
{
	static std::array<size_t, Array_Dimension<T>::dim()> shape()
	{
		if constexpr (std::is_arithmetic_v<T>)
		{
			std::array<size_t, 1> shp;
			shp[0] = 1;
			return shp;
		}
		else
